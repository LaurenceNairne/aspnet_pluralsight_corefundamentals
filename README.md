...
dotnet ef migration add <name_of_class>``` on the command line (when current directory is your project directory) adds a migrations folder and our migration to the project.
